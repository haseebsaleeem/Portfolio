      ...
      {project && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl my-6 sm:my-10 hud-frame always glass rounded-3xl overflow-hidden text-signal-cyan"
          >
            ...
            <div className="relative aspect-video bg-void-deep">
              <video
                key={project.id}
                src={project.video}
                controls
            ...
            <div className="p-6 sm:p-10 text-ink">
